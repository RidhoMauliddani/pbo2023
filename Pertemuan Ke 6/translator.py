...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        nama = Label(nametag, text="Ridho Mauliddani", bg='pink')
        nama.grid(row=6, column=0, sticky=W, padx=5, pady=5)

        kelas = Label(nametag, text="TIF22E", bg='pink')
        ...
        self.from_lang_combobox = ttk.Combobox(mainFrame, values=["id", "en", 'jw', 'ja'])
        ...
        self.to_lang_combobox = ttk.Combobox(mainFrame, values=["en", "id", 'jw', 'sn', 'it', 'ja'])
